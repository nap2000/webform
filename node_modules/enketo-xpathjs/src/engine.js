...
//			},
			...
			lookup_choices : {
				...
				fn: function(source, fn, expression) {

					var value_column = 'doctor';  // TODO
					var label_column = 'doctor';   // TODO

					var url = window.location.protocol + '//' + window.location.hostname;
					url += '/lookup/choices/' + surveyData.surveyIdent;
					url += '/' + source;
					url += "/" + value_column;
					url += "/" + label_column;  // TODO
