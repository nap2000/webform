...
//			},
			...
			get_media : {
				...
				fn: function(a, b)
				{
					var nodeset = b.toNodeSet();
					var tagName = nodeset[0].tagName;
					var value = 'http://sg.smap.com.au/images/cropped-blog1.jpg';
					nodeset[0].setAttribute( 'data-loaded-file-name', value );
					var event = new CustomEvent('inputupdate.enketo');
					nodeset[0].dispatchEvent(event);
					return new StringType("");
				},
