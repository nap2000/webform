...
class DesktopSelectpicker extends Widget {
    ...
    _getTemplate() {
        ...
        <div class="btn-group bootstrap-select widget clearfix">
            <button type="button" class="btn btn-secondary dropdown-toggle clearfix" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        ...
        return [ ...this.element.querySelectorAll( 'option' ) ]
            .map( option => {
                ...
                if ( value ) {
                     ...
                     */
                    return `
                        <li ${checkedLiAttr} role="presentation">
                            <a class="option-wrapper" tabindex="-1" href="#" role="menuitem">
                                <label>
