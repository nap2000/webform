// Vendored from enketo/Leaflet.draw@ff73078 (MIT). Upstream: https://github.com/Leaflet/Leaflet.draw
// Fix applied: added missing `type` var declaration in readableArea() — upstream leaflet-draw unmaintained at 1.0.4.
/*
